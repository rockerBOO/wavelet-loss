...
class TestWaveletLoss:
    ...
    def test_init_dwt(self, setup_inputs):
        ...
        loss_fn = WaveletLoss(
            wavelet="db4", level=3, transform_type="dwt", device=device
        )
    ...
    def test_init_swt(self, setup_inputs):
        _, _, device = setup_inputs
        loss_fn = WaveletLoss(
            wavelet="db4", level=3, transform_type="swt", device=device
        )
    ...
    def test_init_qwt(self, setup_inputs):
        _, _, device = setup_inputs
        loss_fn = WaveletLoss(
            wavelet="db4", level=3, transform_type="qwt", device=device
        )
    ...
    def test_forward_dwt(self, setup_inputs):
        ...
        loss_fn = WaveletLoss(
            wavelet="db4", level=2, transform_type="dwt", device=device
        )
    ...
    def test_forward_swt(self, setup_inputs):
        pred, target, device = setup_inputs
        loss_fn = WaveletLoss(
            wavelet="db4", level=2, transform_type="swt", device=device
        )
    ...
    def test_ll_level_threshold(self, setup_inputs):
        ...
        loss_fn1 = WaveletLoss(
            wavelet="db4",
            level=3,
            transform_type="dwt",
            device=device,
            ll_level_threshold=1,
        )
        loss_fn2 = WaveletLoss(
            wavelet="db4",
            level=3,
            transform_type="dwt",
            device=device,
            ll_level_threshold=2,
        )
        loss_fn3 = WaveletLoss(
            wavelet="db4",
            level=3,
            transform_type="dwt",
            device=device,
            ll_level_threshold=3,
        )
        loss_fn4 = WaveletLoss(
            wavelet="db4",
            level=3,
            transform_type="dwt",
            device=device,
